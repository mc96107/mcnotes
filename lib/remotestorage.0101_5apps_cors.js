...
(function(global) {
  ...
  RS.Dropbox.prototype = {
     ...
     **/
    _getFolder: function(path, options){
      var url = 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/metadata/auto'+path;
      var promise = promising();
          ...
          self._request('PUT', url, {body:body, headers:{'Content-Type':contentType}}, function(err, resp) {
            if (err) {
              ...
              if (response.path === pathTempBeforeClean) {
                ...
                var deleteUrl = 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/fileops/delete?root=auto&path=' + encodeURIComponent(response.path);
    ...
    'delete': function(path, options){
      ...
      promiseMetadata.then(function(metadata) {
        ...
        var url = 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/fileops/delete?root=auto&path=' + encodeURIComponent(pathTempBeforeClean);
     ...
     */
    share: function(path){
      var url = "https://cors.5apps.com/?uri=https://api.dropbox.com/1/media/auto"+path;
      var promise = promising();
     ...
     **/
    info: function() {
      var url = 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/account/info';
      var promise = promising();
    ...
    **/
    fetchDelta: function() {
      ...
      var promise = promising();
      var self = this;
      this._request('POST', 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/delta', {
    ...
    _getMetadata: function(path, options) {
      ...
      var url = 'https://cors.5apps.com/?uri=https://api.dropbox.com/1/metadata/auto' + cleanPath(path);
